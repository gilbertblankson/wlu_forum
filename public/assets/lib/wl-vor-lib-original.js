  ...
  function pLoc(postcode) {
    ...
    var t = Wl.i_postcode(postcode, function(res) {
      ...
      $('#broadband-mobile').removeClass('hide');
        ...
        document.getElementById("broadband-results").innerHTML = "<div class='isd-1'><h6>Broadband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + " mbs</span></div>";
        document.getElementById("broadband-mobile").innerHTML = "<div class='col-xs-6'><h6>Braodband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + "mbs</span></div>";
        ...
        document.getElementById("broadband-results").innerHTML += "<div class='isd-2'><h6>Broadband Average Download Z-Score</h6><span>" + d_speed_zscore + "</span></div>";
        document.getElementById("broadband-mobile").innerHTML += "<div class='col-xs-6'><h6>Broadband Average Download Z-Score</h6><span>" + d_speed_zscore + "</span></div>"; 
        ...
        document.getElementById("broadband-results").innerHTML += "<div class='isd-1'><h6>Broadband Average Upload Speed(mbs)</h6><span>" + u_speed_mbs + " mbs</span></div>";
        document.getElementById("broadband-mobile").innerHTML += "<div class='col-xs-6'><h6>Broadband Average Upload Speed(mbs)</h6><span>" + u_speed_mbs + "mbs</span></div>";
        ...
        document.getElementById("broadband-results").innerHTML += "<div class='isd-2'><h6>Broadband Average Upload Z-Score</h6><span>" + u_speed_zscore + "</span></div>";
        document.getElementById("broadband-mobile").innerHTML += "<div class='col-xs-6'><h6>Broadband Average Upload Z-Score</h6><span>" + u_speed_zscore + "</span></div>";
        //$('.popup span.upz, .mobile-search-results span.upz').text(u_speed_zscore);
          ...
          // if subs "broadband-dropdowns" are selected
            ...
            // data for average download speed(mbs)
            document.getElementById("broadband-results").innerHTML = "<div class='isd-1'><h6>Broadband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + " mbs</span></div>";
            document.getElementById("broadband-mobile").innerHTML = "<div class='col-xs-6'><h6>Broadband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + " mbs</span></div>";
            ...
            var d_speed_zscore = res.Broadband.average_dload_speed_zscore;
            var d_speed_zscore = (Number(d_speed_zscore).toFixed(2));
            document.getElementById("broadband-results").innerHTML = "<div class='isd-1'><h6>Broadband Average Download Z-Score</h6><span>" + d_speed_zscore + "</span></div>";
            document.getElementById("broadband-mobile").innerHTML = "<div class='col-xs-6'><h6>Broadband Average Download Z-Score</h6><span>" + d_speed_zscore + "</span></div>";
            ...
            var u_speed_zscore = res.Broadband.average_upload_speed_zscore;
            var u_speed_zscore = (Number(u_speed_zscore).toFixed(2));
            document.getElementById("broadband-results").innerHTML = "<div class='isd-1'><h6>Broadband Average Upload Z-Score</h6><span>" + u_speed_zscore + "</span></div>";
            document.getElementById("broadband-mobile").innerHTML = "<div class='col-xs-6'><h6>Broadband Average Upload Z-Score</h6><span>" + u_speed_zscore + "</span></div>";
              ...
              // data for upload speed(mbs)
              var u_speed_mbs = res.Broadband.average_upload_speed_mbs;
              document.getElementById("broadband-results").innerHTML += "<div class='isd-2'><h6>Broadband Average Upload Speed(mbs)</h6><span>" + u_speed_mbs + " mbs</span></div>";
              document.getElementById("broadband-mobile").innerHTML += "<div class='col-xs-6'><h6>Broadband Average Upload Speed(mbs)</h6><span>" + u_speed_mbs + " mbs</span></div>";
              ...
              // data for average download speed(mbs)
              document.getElementById("broadband-results").innerHTML = "<div class='isd-1'><h6>Broadband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + " mbs</span></div>";
              document.getElementById("broadband-mobile").innerHTML = "<div class='col-xs-6'><h6>Broadband Average Download Speed(mbs)</h6><span>" + d_speed_mbs + "</span></div>";
      ...
      if (res.TallBuildings != null) {
          ...
          if ((document.getElementById("tallbuilings-title").checked == true && document.getElementById("ltbc").checked == true && document.getElementById("wtbs").checked == true && document.getElementById("wtbc").checked == true || document.getElementById("tallbuildings-m-title").checked == true && document.getElementById("m-ltbc").checked == true && document.getElementById("m-wtbs").checked == true && document.getElementById("m-wtbc").checked == true)) {
              ...
              if (local_tbuild_c == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h5 class='text-center'>TALL BUILDINGS INFORMATION</h5><div class='col-xs-6'><h6>Local Tall Buildings Count</h6><span>0</span></div>";
              } else {
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h5 class='text-center'>TALL BUILDINGS INFORMATION</h5><div class='col-xs-6'><h6>Local Tall Buildings Count</h6><span>" + local_tbuild_c + "</span></div>";
              }
            ...
            var walulel_tbuild_s = res.TallBuildings.walulel_tall_building_impact_score;
              if (walulel_tbuild_s == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML += "<div class='col-xs-6'><h6>Walulel Tall Building Impact Score</h6><span>0</span></div>";
              } else {
                  ...
                  document.getElementById("tall-mobile").innerHTML += "<div class='col-xs-6'><h6>Walulel Tall Building Impact Score</h6><span>" + walulel_tbuild_s + "</span></div>";
              }
            ...
            var walulel_tbcs = res.TallBuildings.walulel_tb_cluster_effect_score;
              if (walulel_tbcs == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML += "<div class='col-xs-6'><h6>Walulel Tall Building Cluster Effect Score</h6><span>0</span></div>";
              } else {
                  ...
                  document.getElementById("tall-mobile").innerHTML += "<div class='col-xs-6'><h6>Walulel Tall Building Cluster Effect Score</h6><span>" + walulel_tbcs + "</span></div>";
              }
              ...
              if (local_tbuild_c == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Local Tall Buildings Count</h6><span>0</span></div>";
              } else {
                  document.getElementById("tallbuildings-results").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='isd-1'><h6>Local Tall Buildings Count</h6><span>" + local_tbuild_c + "</span></div>";
                  
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Local Tall Buildings Count</h6><span>" + local_tbuild_c + "</span></div>";
              }
            ...
            var walulel_tbuild_s = res.TallBuildings.walulel_tall_building_impact_score;
              if (walulel_tbuild_s == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Walulel Tall Building Impact Score</h6><span>0</span></div>";
              } else {
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Walulel Tall Building Impact Score</h6><span>" + walulel_tbuild_s + "</span></div>";
              }
            ...
            var walulel_tbcs = res.TallBuildings.walulel_tb_cluster_effect_score;
              if (walulel_tbcs == null){
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Walulel Tall Building Cluster Effect Score</h6><span>0</span></div>";
              } else {
                  ...
                  document.getElementById("tall-mobile").innerHTML = "<h4 class='text-center'>TALL BUILDINGS INFORMATION</h4><div class='col-xs-6'><h6>Walulel Tall Building Cluster Effect Score</h6><span>" + walulel_tbcs + "</span></div>";
              }
...
function get_gppractices(postcode) {
  ...
  var t = Wl.nhs_gppractices(postcode, function(res) {
    ...
    if (obj != null) {
        if ((document.getElementById("nhs-title").checked == true)){
...
// Slide up for Mobile Expand Popup
//$('#mobile-expand-ss').click(function() {
//    if($('.mobile-expand-popup').hasClass('slide-left')) {
//        $('.mobile-expand-popup').addClass('slide-right', 1000);
//        $('.mobile-expand-popup').removeClass('slide-left');
//    } else {
//        $('.mobile-expand-popup').removeClass('slide-right');
//        $('.mobile-expand-popup').delay(800).addClass('slide-left', 1000);
//    }
//});
