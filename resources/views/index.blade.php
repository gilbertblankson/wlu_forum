@include('includes.page-meta-data')
    ...
    <title>WALULEL</title>
    <link rel="stylesheet" href="/css/walulel.css" type="text/css">
...
<header>@include('includes.site-navigation')</header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-3 col-md-6 col-sm-12 text-center">
                    ...
                    <p style="color:#fff">Your locale like you've never known. &copy; Walulel Limited {{\Carbon\Carbon::now()->year}}.</p>
                </div>
            </div>
        </div>
    </footer>
